...
static void motion_init(struct context *cnt)
{
	...
	/* valgrind complains when alg.c references it when uninitialised */
	memset(cnt->imgs.smartmask_final, 0, sizeof(cnt->imgs.motionsize));
